...
payment_methods = {
	...
	'DCC': 'ACH Demand Corporate Credit or Debit (CCD) Credit',
	'DCD': 'ACH Demand Corporate Credit or Debit (CCD) Debit',
	'DDP': 'Direct Deposit',
	'DEB': 'Debit Card',
	...
	'DZC': 'ACH Demand Corporate Credit or Debit Plus (CCD+) Credit',
	'DZD': 'ACH Demand Corporate Credit or Debit Plus (CCD+) Debit',
	...
	'QDR': 'Qualified Direct Rollover',
	'QIR': 'Qualified Indirect Rollover',
	'REV': 'ACH Reversal',
	'RTP': 'Real-Time Payment',
	'SCC': 'ACH Savings Corporate Credit or Debit (CCD) Credit',
	'SCD': 'ACH Savings Corporate Credit or Debit (CDD) Debit',
	...
	'SZC': 'ACH Savings Corporate Credit or Debit Plus (CCD+) Credit',
	'SZD': 'ACH Savings Corporate Credit or Debit Plus (CCD+) Debit',
